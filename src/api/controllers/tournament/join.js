 ...
 */
module.exports = (app) => {
  app.post('/tournament/:id/join', [isAuth('tournament-join')]);

  app.post('/tournament/:id/join', async (req, res) => {
    ...
    try {
      ...
      // tournament needs team and user has no team
      ...
      // tournament needs team and user is not a captain
