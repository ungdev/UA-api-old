...
module.exports = async () => {
  ...
  api.use(process.env.NODE_ENV !== 'test' ? '/api/v1' : '/', MainRoutes(models));
  api.use(`${process.env.NODE_ENV !== 'test' ? '/api/v1' : '/'}/uploads`, Express.static(process.env.ARENA_FILES_TO_SERVE));
